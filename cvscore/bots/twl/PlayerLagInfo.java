...
public class PlayerLagInfo extends PlayerInfo
{
  ...
  public PlayerLagInfo(BotAction botAction, String playerName, int spikeSize, LogWriter logFile)
  {
    super(botAction, playerName, logFile);
    if(spikeSize < 0)
  ...
  public PlayerLagInfo(BotAction botAction, String playerName, int spikeSize)
  {
    this(botAction, playerName, spikeSize, null);
  }
  ...
  public PlayerLagInfo(BotAction botAction, String playerName, LogWriter logFile)
  {
    this(botAction, playerName, DEFAULT_SPIKE_SIZE, logFile);
  }

  public PlayerLagInfo(BotAction botAction, String playerName)
  {
    this(botAction, playerName, DEFAULT_SPIKE_SIZE, null);
  }
