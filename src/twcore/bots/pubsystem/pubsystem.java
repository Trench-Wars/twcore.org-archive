...
public class pubsystem extends SubspaceBot
{
    ...
    public void handleEvent(LoggedOn event)
    {
        ...
        warpPtsLeftX = botSettings.getIntArray("warpLeftX", ",");
        warpPtsLeftY = botSettings.getIntArray("warpLeftY", ",");
        warpPtsRightX = botSettings.getIntArray("warpRightX", ",");
        warpPtsRightY = botSettings.getIntArray("warpRightY", ",");
    }
