...
;
	...
	if (duelG) {
		if (wbG) {
		    out.add("|                          ,------+------+-----------+----+");
		    out.add("| " + Tools.formatString(m_fcTeamName, 23) + " /  " + rightenString(Integer.toString(getDTotalStats(TOTAL_KILLS)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(DEATHS)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(RATING)), 9) + " | " + rightenString(Integer.toString(getTotalLagOuts()), 2) + " |");
		    out.add("+------------------------'        |      |           |    |");

		    for (int i = players.length - 1; i >= 0; i--) {
			MatchPlayer p = (MatchPlayer)players[i];
			out.add("|  " + Tools.formatString(p.getPlayerName(), 25) + " " + rightenString(Integer.toString(p.getTotalStatistic(TOTAL_KILLS)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(DEATHS)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(RATING)), 9) + " | " + rightenString(Integer.toString(p.getLagOuts()), 2) + " |");
		    }
		} else {
		    out.add("|                          ,------+------+------+-----------+----+");
		    out.add("| " + Tools.formatString(m_fcTeamName, 23) + " /  " + rightenString(Integer.toString(getDTotalStats(TOTAL_KILLS)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(DEATHS)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(TOTAL_TEAMKILLS)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(RATING)), 9) + " | " + rightenString(Integer.toString(getTotalLagOuts()), 2) + " |");
		    out.add("+------------------------'        |      |      |           |    |");

		    for (int i = players.length - 1; i >= 0; i--) {
			MatchPlayer p = (MatchPlayer)players[i];
			out.add("|  " + Tools.formatString(p.getPlayerName(), 25) + " " + rightenString(Integer.toString(p.getTotalStatistic(TOTAL_KILLS)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(DEATHS)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(TOTAL_TEAMKILLS)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(RATING)), 9) + " | " + rightenString(Integer.toString(p.getLagOuts()), 2) + " |");
		    }
		}
	} else {
	    out.add("|                          ,------+------+------+-----------+------+------+-----------+----+");
	    out.add("| " + Tools.formatString(m_fcTeamName, 23) + " /  " + rightenString(Integer.toString(getDTotalStats(TOTAL_KILLS)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(DEATHS)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(TOTAL_TEAMKILLS)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(SCORE)), 9) + " | " + rightenString(Integer.toString(getDTotalStats(FLAG_CLAIMED)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(TERRIER_KILL)), 4) + " | " + rightenString(Integer.toString(getDTotalStats(RATING)), 9) + " | " + rightenString(Integer.toString(getTotalLagOuts()), 2) + " |");
	    out.add("+------------------------'        |      |      |           |      |      |           |    |");

	    for (int i = players.length - 1; i >= 0; i--) {
		MatchPlayer p = (MatchPlayer)players[i];
		out.add("|  " + Tools.formatString(p.getPlayerName(), 25) + " " + rightenString(Integer.toString(p.getTotalStatistic(TOTAL_KILLS)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(DEATHS)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(TOTAL_TEAMKILLS)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(SCORE)), 9) + " | " + rightenString(Integer.toString(p.getTotalStatistic(FLAG_CLAIMED)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(TERRIER_KILL)), 4) + " | " + rightenString(Integer.toString(p.getTotalStatistic(RATING)), 9) + " | " + rightenString(Integer.toString(p.getLagOuts()), 2) + " |");
	    }
