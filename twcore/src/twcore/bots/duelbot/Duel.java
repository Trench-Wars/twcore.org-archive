...
public class Duel {
    ...
    */
    ...
    public int getXOne() {
        return m_duelBox.getXOne();
    }
    public int getXTwo() {
        return m_duelBox.getXTwo();
    }
    public int getYOne() {
        return m_duelBox.getYOne();
    }
    public int getYTwo() {
        return m_duelBox.getYTwo();
    }
    public int getSafeXOne() {
        return m_duelBox.getSafeXOne();
    }
    public int getSafeXTwo() {
        return m_duelBox.getSafeXTwo();
    }
    public int getSafeYOne() {
        return m_duelBox.getSafeYOne();
    }
    public int getSafeYTwo() {
        return m_duelBox.getSafeYTwo();
    }
    public boolean winBy2() {
        return m_winBy2;
    }
    public boolean noCount() {
        return m_noCount;
    }
    public boolean deathWarp() {
        return m_deathWarp;
    }
    public int toWin() {
        return m_toWin;
