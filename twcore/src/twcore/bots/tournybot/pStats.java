...
public class pStats {
    ...
    public void setRandomT(boolean r) {
        randomT = r;
    }

    public boolean getRandomT() {
        return randomT;
    }
    ...
    public void setFreq(String sFreq) {
        freq = sFreq;
    }
    ...
    public int timeFromLastReturn() {
        return (int)(System.currentTimeMillis() / 1000) - lastReturn;
    }
    ...
    public boolean getQSent() {
        return qSent;
    }

    public void setQSent(boolean q) {
        qSent = q;
    }
}
