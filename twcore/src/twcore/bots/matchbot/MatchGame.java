    ...
    public void reportEndOfRound(boolean m_fbAffectsEntireGame) {
        ...
        if ((m_fnTeam1Score == (rounds + 1) / 2) || (m_fnTeam2Score == (rounds + 1) / 2)) {
            ...
            if (m_matchTypeName.equals("TWD Basing"))
                m_botAction.ipcTransmit("MatchBot", new IPCTWD(EventType.STATE, m_botAction.getArenaName(), m_botAction.getBotName(), m_fcTeam1Name, m_fcTeam2Name, m_fnMatchID));
            else
                m_botAction.ipcTransmit("MatchBot", new IPCTWD(EventType.STATE, m_botAction.getArenaName(), m_botAction.getBotName(), m_fcTeam1Name, m_fcTeam2Name, m_fnMatchID, m_fnTeam1Score, m_fnTeam2Score));
