...
public class distensionbot extends SubspaceBot {
    ...
    private int PRIZE_SPAM_DELAY = 22;                     // Delay in ms between prizes for individual players
    ...
    */
    ...
    public void cmdOpsNav1(String name, String msg) {
        cmdOpsNav(name, 1);
    }
    public void cmdOpsNav11(String name, String msg) {
        cmdOpsNav(name, 11);
    }
    public void cmdOpsNav12(String name, String msg) {
        cmdOpsNav(name, 12);
    }
    public void cmdOpsNav13(String name, String msg) {
        cmdOpsNav(name, 13);
    }
    public void cmdOpsNav2(String name, String msg) {
        cmdOpsNav(name, 2);
    }
    public void cmdOpsNav21(String name, String msg) {
        cmdOpsNav(name, 21);
    }
    public void cmdOpsNav22(String name, String msg) {
        cmdOpsNav(name, 22);
    }
    public void cmdOpsNav23(String name, String msg) {
        cmdOpsNav(name, 23);
    }
    public void cmdOpsNav3(String name, String msg) {
        cmdOpsNav(name, 3);
    }
    public void cmdOpsNav31(String name, String msg) {
        cmdOpsNav(name, 31);
    }
    public void cmdOpsNav32(String name, String msg) {
        cmdOpsNav(name, 32);
    }
    ...
    */
    public void cmdOpsNav( String name, int spot ) {
        ...
        if( p.getArmyID() % 2 == 0 ) {
            switch( spot ) {
            case 1:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, TOP_FR_NAV );
                break;

            case 11:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, TOP_MID_NAV );
                break;

            case 12:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, TOP_TUBE_NAV );
                break;

            case 13:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, REARM_AREA_TOP_Y );
                break;

            case 2:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, BOT_FR_NAV );
                break;

            case 21:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, BOT_MID_NAV );
                break;

            case 22:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, BOT_TUBE_NAV );
                break;

            case 23:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, REARM_AREA_BOTTOM_Y );
                break;

            case 3:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, 512 );
                break;

            case 31:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, LEFT_GOAL_NAV );
                break;

            case 32:
                m_botAction.warpTo( p.getArenaPlayerID(), 512, RIGHT_GOAL_NAV );
                break;
            }
        } else {
            switch( spot ) {
    ...
    public void cmdOpsRadar( String name, String msg ) {
        ...
        for( Player p2 : m_botAction.getPlayingPlayers() ) {
            ...
            if( p2.getFrequency() == p.getArmyID() )
                if( p2.getShipType() == Tools.Ship.TERRIER )
                    fterrs[index]++;
                else if( p2.getShipType() == Tools.Ship.SHARK )
                    fsharks[index]++;
                else
                    fships[index]++;
            else if( p2.getShipType() == Tools.Ship.TERRIER )
                eterrs[index]++;
            else if( p2.getShipType() == Tools.Ship.SHARK )
                esharks[index]++;
            else
    ...
    */
    public void cmdOpsWarp( String name, String msg ) {
        ...
        if( freq % 2 == 0 ) {
            switch( warpPoint ) {
            case 1:
                m_botAction.warpTo(p2.getPlayerID(), OPS_TOP_WARP1_X, OPS_TOP_WARP1_Y );
                break;

            case 2:
                m_botAction.warpTo(p2.getPlayerID(), OPS_TOP_WARP2_X, OPS_TOP_WARP2_Y );
                break;

            case 3:
                m_botAction.warpTo(p2.getPlayerID(), OPS_TOP_WARP3_X, OPS_TOP_WARP3_Y );
                break;

            case 4:
                m_botAction.warpTo(p2.getPlayerID(), OPS_TOP_WARP4_X, OPS_TOP_WARP4_Y );
                break;

            case 5:
                m_botAction.warpTo(p2.getPlayerID(), OPS_TOP_WARP5_X, OPS_TOP_WARP5_Y );
                break;

            case 6:
                m_botAction.warpTo(p2.getPlayerID(), OPS_TOP_WARP6_X, OPS_TOP_WARP6_Y );
                break;
            }
        } else {
            switch( warpPoint ) {
            case 1:
                m_botAction.warpTo(p2.getPlayerID(), OPS_BOT_WARP1_X, OPS_BOT_WARP1_Y );
                break;

            case 2:
                m_botAction.warpTo(p2.getPlayerID(), OPS_BOT_WARP2_X, OPS_BOT_WARP2_Y );
                break;

            case 3:
                m_botAction.warpTo(p2.getPlayerID(), OPS_BOT_WARP3_X, OPS_BOT_WARP3_Y );
                break;

            case 4:
                m_botAction.warpTo(p2.getPlayerID(), OPS_BOT_WARP4_X, OPS_BOT_WARP4_Y );
                break;

            case 5:
                m_botAction.warpTo(p2.getPlayerID(), OPS_BOT_WARP5_X, OPS_BOT_WARP5_Y );
                break;

            case 6:
                m_botAction.warpTo(p2.getPlayerID(), OPS_BOT_WARP6_X, OPS_BOT_WARP6_Y );
                break;
            }
        }
    ...
    private class DistensionPlayer {
        ...
        */
        public void prizeSpecialAbilities( int tick ) {
            ...
            if( shipNum == 5 ) {
                ...
                default:
                    neededTick = 40;
                    break;    // 10m (for only freebie version)
                }
        ...
        */
        public int getStrength() {
            switch(shipNum) {
            case 5:
                return getRank() + TERR_RANK_0_STRENGTH;

            case 8:
                return getRank() + SHARK_RANK_0_STRENGTH;

            case 9:
                return getRank() + OPS_RANK_0_STRENGTH;
        ...
        if( winningArmyID == 0 || winningArmyID == 1 ) {
            if( winningArmyID == 0 )
                if( m_freq1Score > m_freq0Score )
                    ...
                    m_freq0Score++;
            else if( m_freq0Score > m_freq1Score )
                m_freq0Score--;
            else
                m_freq1Score++;
