...
public class PasswordPacketResponse {
    ...
    public String getResponseMessage() {
        ...
        switch( m_response ) {
            ...
            case response_LockedOut:		return "Locked out of zone";
            case response_NoPermission:		return "Permission only arena";
            case response_SpectateOnly:		return "Permission to spectate only";
            case response_TooManyPoints:	return "Too many points to play here";
            case response_SlowConnection:	return "Connection is too slow";
            case response_NoPermission2:	return "You do not have permission to play in this arena";
            case response_NoNewConnections:	return "The server is currently not accepting new connections.";
            case response_InvalidName:		return "Invalid name";
            case response_ObsceneName:		return "Obscene name";
            case response_BillerDown:		return "No active biller"; //no scores will be recorded
            case response_BusyProcessing:	return "Server busy, try later";
            case response_ExperiencedOnly:	return "Restricted zone"; //Usually based on insufficient usage
            case response_UsingDemoVersion:	return "Demo version detected";
            case response_TooManyDemos:		return "Too many demo users";
            case response_ClosedToDemos:	return "Demo versions not allowed";
            case response_NeedModerator:	return "Restricted zone, mod access required";
