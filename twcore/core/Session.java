...
public class Session extends Thread {
    ...
    private boolean 		m_connectedToAsss;
    ...
    public void setServerType(boolean isAsss)
    {
		m_connectedToAsss = isAsss;
	}

	public boolean isConnectedToAsss()
	{
		return m_connectedToAsss;
	}
